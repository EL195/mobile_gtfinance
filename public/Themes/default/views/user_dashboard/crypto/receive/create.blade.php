...
<!-- jquery-qrcode -->
<script src="{{asset('public/js/jquery-qrcode/jquery.qrcode.min.js')}}" type="text/javascript"></script>
<script src="{{asset('public/js/jquery-qrcode/qrcode.js')}}" type="text/javascript"></script>
<!-- sweetalert -->
<script src="{{asset('public/js/sweetalert/sweetalert-unpkg.min.js')}}" type="text/javascript"></script>
