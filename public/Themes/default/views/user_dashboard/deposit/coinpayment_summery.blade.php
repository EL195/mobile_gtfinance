        ...
        <div class="p-2 my-3">
            <div class="container">
                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-md-12 col-lg-8  px-0 card py-4">
                        ...
                        <div class="row px-4 py-2">
                            ...
                            <div class="col-md-7">
                                <p>{{ $transactionInfo['result']['amountf'] }} ({{ __('Total confirms need') }}:
                        ...
                        <div class="row px-4 py-2">
                            ...
                            <div class="col-md-7">
                                <p>{{ $transactionInfo['result']['receivedf'] }}</p>
                            </div>
                        </div>
                        <hr class="mt-2 mb-0">
                        ...
                        <div class="row px-4 py-2">
                            ...
                            <div class="col-md-7">
                                <p>{{ $transactionInfo['result']['amountf'] }}</p>
                            </div>
                        </div>
                        <hr class="mt-2 mb-0">

                        <div class="row justify-content-center">
                            <img src="{{ $transactionDetails['result']['qrcode_url'] }}" alt="image" class="w-200px">
                        </div>
