        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-xs-12">
                ...
                <div class="right mb10">
                    <a href="{{url('/payout')}}" class="btn btn-grad"><i class="fa fa-arrow-up"></i>&nbsp;@lang('message.dashboard.payout.new-payout.title')</a>
                </div>
                            ...
                            <table class="table recent_activity">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><h4>{{ ($payout->payment_method->name == "Mts") ? getCompanyName() : $payout->payment_method->name }}</h4></td>
                                        ...
                                        <td class="text-center">{{ ($payoutFee == 0) ? '-' : formatNumber($payoutFee) }}</td>
                                        <td class="text-center"><h4>{{ formatNumber($payout->amount) }}</h4></td>
                                        <td class="text-center">{{ $payout->currency->code }}</td>
