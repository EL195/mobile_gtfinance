...
<html lang="en">
	    <head>
	        ...
	        <!--css styles-->
	        <link rel="stylesheet" type="text/css" href="{{theme_asset('public/user_dashboard/css/bootstrap.min.css')}}">
			<link rel="stylesheet" type="text/css" href="{{theme_asset('public/user_dashboard/css/themify-icons.css')}}">
			<link rel="stylesheet" type="text/css" href="{{theme_asset('public/user_dashboard/css/font-awesome-4.7.0/css/font-awesome.min.css')}}">
			<link rel="stylesheet" type="text/css"  href="{{theme_asset('public/user_dashboard/css/reset.css')}}">
			<link rel="stylesheet" type="text/css"  href="{{theme_asset('public/user_dashboard/css/style.css')}}">
			<link rel="stylesheet" type="text/css"  href="{{theme_asset('public/user_dashboard/css/responsive.css')}}">
			<link rel="stylesheet" type="text/css"  href="{{theme_asset('public/user_dashboard/css/animate.min.css')}}">
			<link rel="stylesheet" type="text/css" href="{{ theme_asset('public/user_dashboard/css/sweetalert/sweetalert.css')}}">
    ...
    <body>
		        ...
		        <div class="container">
		            @if (isset($logo))
		                <a style="max-height:100%;margin-left:5px;width: 157px;overflow: hidden;" class="navbar-brand logo_area" href="{{url('/')}}">
		                    <img src="{{theme_asset('public/images/logos/'.$logo)}}" alt="logo" class="img-responsive img-fluid">
		                </a>
		            @else
		                <a style="max-height:100%;margin-left:5px;width: 157px;overflow: hidden;" class="navbar-brand logo_area" href="{{url('/')}}">
        ...
        <footer>
		  <div class="container">
		      <div class="row">
		          <div class="col-md-12">
		              <p class="copyright">{{ __('Copyright')}} &copy; {{date('Y')}} &nbsp;&nbsp; {{ $company_name }} | {{ __('All rights reserved') }}</p>
		          </div>
		      </div>
		  </div>
		</footer>
    ...
    <!--javascript-->
	<script src="{{theme_asset('public/user_dashboard/js/jquery.min.js')}}" type="text/javascript"></script>

    <!--bootstrap-->
	<script src="{{theme_asset('public/user_dashboard/js/bootstrap.min.js')}}" type="text/javascript"></script>

    <!--jquery waypoints-->
	<script src="{{theme_asset('public/user_dashboard/js/jquery.waypoints.min.js')}}" type="text/javascript"></script>

    <!--main-->
	<script src="{{theme_asset('public/user_dashboard/js/main.js')}}" type="text/javascript"></script>

	<!-- iCheck -->
	<script src="{{ url('public/user_dashboard/css/iCheck/icheck.min.js') }}" type="text/javascript"></script>

	<!-- sweetalert -->
	<script src="{{ theme_asset('public/user_dashboard/css/sweetalert/sweetalert.min.js')}}" type="text/javascript"></script>
	        ...
	        new Fingerprint2().get(function(result, components)
	        {
	            ...
	            .done(function(data)
	            {
	            	if (data.status == false) {
						swal({
							title: "{{ __('Error') }}",
							text: "{{ __('Verification is code is invalid.') }}",
							type: "error"
						});
					} else {
	                	window.location.href="{{ url('dashboard') }}";
