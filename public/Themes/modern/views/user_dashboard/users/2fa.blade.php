        ...
        <div class="container-fluid">
            ...
            <div class="mt-5 border-bottom">
                <div class="d-flex flex-wrap">
                    <a href="{{ url('/profile') }}">
                        <div class="mr-4 pb-3">
                            <p class="text-16 text-gray-500">{{ __('Profile') }}</p>
                        </div>
                    </a>

                    <a href="{{ url('/profile/2fa') }}">
                        <div class="mr-4 border-bottom-active pb-3">
                            <p class="text-16 font-weight-500 text-active"> {{ __('2-FA') }} </p>
                        </div>
                    </a>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div>
                                                                    <div style="text-align: center;">
                                                                        ...
                                                                        <button class="btn btn-primary px-4 py-2 transfer_form">@lang('message.google2fa.proceed')</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
