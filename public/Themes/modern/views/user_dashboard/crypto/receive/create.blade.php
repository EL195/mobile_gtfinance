                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <div class="input-group-append wallet-address-copy-btn">
                                                        <span class="input-group-text btn-cancel " >@lang('message.dashboard.crypto.receive.address-input-copy-text')</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<!-- jquery-qrcode -->
<script src="{{theme_asset('public/user_dashboard/js/jquery-qrcode/jquery.qrcode.min.js')}}" type="text/javascript"></script>
<script src="{{theme_asset('public/user_dashboard/js/jquery-qrcode/qrcode.js')}}" type="text/javascript"></script>
<!-- sweetalert -->
<script src="{{theme_asset('public/user_dashboard/js/sweetalert/sweetalert-unpkg.min.js')}}" type="text/javascript"></script>
