                        ...
                        <td>
                            <table style="margin-top:20px; width:300px;">
                                ...
                                <tr style="padding-bottom:10px;">
                                    ...
                                    <td style="font-size:15px; color:#4e5c6e; text-align:right;">{{ moneyFormat($transaction->currency->symbol, config('crypto_exchange.is_active') ? $network_fee : $transaction->charge_fixed) }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-size:15px; color:#4e5c6e; text-align:right; font-weight:bold;">{{ moneyFormat($transaction->currency->symbol, config('crypto_exchange.is_active') ? ($transaction->total-$network_fee) : $transaction->total) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
