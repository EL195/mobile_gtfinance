            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4 mt-4">
                    <div class="h-100  p-4">
                        <div class="d-flex">
                            <div>
                                <i class="fas fa-university text-24"></i>
                            </div>
                        </div>

                        <div class="mt-3">
                            <h4 class="text-service">{{ __('Banking and transaction') }}</h4>
                            <p class="mt-3 text-gray-500">{{ __('Provide your customers a convenient way of banking and secured transaction for day to day life.') }}</p>
                        </div>
                    </div>
                </div>
            </div>
