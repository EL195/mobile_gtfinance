                          ...
                          <div class="bg-secondary rounded mt-5 mb-30 shadow p-35">
                                ...
                                @if (!empty($errorMessage))
                                  <div class="text-center">
                                    <p class="font-weight-600">@lang('message.dashboard.send-request.send.confirmation.money-send') @lang('message.dashboard.mail-not-sent').
                                         <br/>
                                ...
                                <p class="text-center">@lang('message.dashboard.send-request.send.confirmation.transfer-amount') : {{  moneyFormat($transInfo['currSymbol'], formatNumber($transInfo['amount'])) }}</p>
