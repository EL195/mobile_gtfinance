                                        ...
                                        <div class="col-md-12 mt-4">
                                            <div class="d-flex shadow bg-secondary p-5 justify-content-between">
                                                ...
                                                @if ($wallet->currency->type != 'fiat' && $wallet->currency->status == 'Active')
                                                    <div>
                                                        <div class="pr-2">
                                                            <a href="{{ url("/crpto/send/".$walletCurrencyCode."/".$walletId) }}">
                                                                <p class="crypto-link"> <i class="fas fa-share-square"></i> {{ __('Send') }} </p>
                                                            </a>

                                                            <a href="{{ url("/crpto/receive/".$walletCurrencyCode."/".$walletId) }}">
                                                                <p class="crypto-link mt-3"> <i class="fas fa-hand-holding-usd"></i> {{ __('Receive') }}</p>
                                                            </a>
                                                        </div>
                                                    </div>
                                                @elseif ($wallet->currency->type == 'fiat' && $wallet->currency->status == 'Active')
                                                    <div>
                                                        <div class="pr-2">
                                                            {{-- <a href="{{ url("/deposit") }}"> --}}
                                                            <a href="/Interac">
