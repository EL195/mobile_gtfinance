      ...
      <div class="container py-5">
          <div class="row py-5">
              <div class="col-md-7 py-5">
                  <div>
                      <h2 style="color: #8cc542;" class="text-36">{{ __('Make Your Transaction') }}</h2>
                      <p  style="color: white;" class="text-20 text-white-300">{{ __('Easy cheapest and secure') }}</p>
                  </div>

                  <div class="mt-4 mw-450">
                      <p style="color: white;" class="head-sub-title">{{ __('Sending money globally with multiple currencies to your beloved one easily, safely & securely with low fees in just few minutes.') }}</p>
                  </div>
...
<section class="mt-60 bg-white">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 style="color:#8cc542; font-weight:900;" class="text-28 title">@lang('message.home.choose-us.title')</h2>
                <hr class="p-2" style="width: 25px;border-top: 10px groove #8cc542;border-top-left-radius: 25px;">

                <div class="row  d-flex flex-wrap mt-4" style="display:none!important;">
                    <div class="p-2">
...
<section class="mt-60 " style="background:#fbfbfb;padding-top:50px; padding-bottom:50px;">
    <div class="container">
        <div class="row d-flex justify-content-center ">
            <div class="title-bar">
                <h2 style="color:#8cc542; font-weight:900;" class="text-28 title text-center">{{ __('What can you do?') }}</h2>
...
<section class="bg-image" style="display:none;">
...
<section class="mt-60 bg-white">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <h2 style="color:#8cc542; font-weight:900;" class="text-28 title">{{ __('How does it work?') }}</h2>
                <hr class="p-2" style="width: 25px;border-top: 10px groove #8cc542;border-top-left-radius: 25px;">
...
<section class="mt-60 mb-120 bg-white" style="display:none;">
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div>
