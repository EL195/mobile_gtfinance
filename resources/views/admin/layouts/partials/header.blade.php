<header class="main-header">
    ...
    <a href="{{ route('dashboard') }}" class="logo">
        ...
        @if (!empty($company_logo))
            <img src="/assets/img/logo.png" width="120" height="70" class="company-logo">
        @else
            <img src="{{ url('public/uploads/userPic/default-logo.jpg') }}" width="180" height="59" class="company-logo">
        @endif
    </a>
    </div>
...
<div class="flash-container">
    @if(Session::has('message'))
        <div class="alert mt-20 {{ Session::get('alert-class') }} text-center" style="margin-bottom:0px;" role="alert">
          {{ Session::get('message') }}
