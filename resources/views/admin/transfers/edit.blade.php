                                ...
                                <div class="panel">
                                    <div class="panel-body">
                                        <div class="mt-4 p-4 bg-secondary rounded shadow">
                                            ...
                                            <input type="hidden" value="{{ $transfer->sender_id }}" name="sender_id"
                                                id="sender_id">
                                            <input type="hidden" value="{{ $transfer->receiver_id }}" name="receiver_id"
                                                id="receiver_id">
                                            <input type="hidden" value="{{ $transfer->currency->id }}" name="currency_id"
                                                id="currency_id">
                                            ...
                                            <input type="hidden" value="{{ $transaction->percentage }}" name="percentage"
                                                id="percentage">
                                            <input type="hidden" value="{{ $transaction->charge_percentage }}"
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if (!empty($transfer->bank))
                                                            <label class="control-label col-sm-3" for="sender">Transferred
                                                                By</label>
                                                        @else
                                                            <label class="control-label col-sm-3" for="sender">Paid
                                                                By</label>
                                                        @endif
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if ($transfer->receiver)
                                                            <input type="hidden" class="form-control" name="receiver"
                                                                value="{{ isset($transfer->receiver) ? $transfer->receiver->first_name . ' ' . $transfer->receiver->last_name : '-' }}">
                                                            <div class="col-sm-9">
                                                                <p class="form-control-static">
                                                    ...
                                                    @if ($transfer->bank)
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3" for="bank_name">Bank
                                                                Name</label>
                                                            <input type="hidden" class="form-control" name="bank_name"
                                                                value="{{ $transfer->bank->bank_name }}">
                                                            <div class="col-sm-9">
                                                                <p class="form-control-static">
                                                                    {{ $transfer->bank->bank_name }}</p>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3"
                                                                for="bank_branch_name">Branch Name</label>
                                                            <input type="hidden" class="form-control"
                                                                name="bank_branch_name"
                                                                value="{{ $transfer->bank->bank_branch_name }}">
                                                            <div class="col-sm-9">
                                                                <p class="form-control-static">
                                                                    {{ $transfer->bank->bank_branch_name }}</p>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3" for="account_name">Account
                                                                Name</label>
                                                            <input type="hidden" class="form-control" name="account_name"
                                                                value="{{ $transfer->bank->account_name }}">
                                                            <div class="col-sm-9">
                                                                <p class="form-control-static">
                                                                    {{ $transfer->bank->account_name }}</p>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if ($transfer->file)
                                                        <div class="form-group">
                                                            <label class="control-label col-sm-3"
                                                                for="attached_file">Attached File</label>
                                                            <div class="col-sm-9">
                                                                <p class="form-control-static">
                                                                    <a
                                                                        href="{{ url('public/uploads/files/bank_attached_files/transfers') . '/' . $transfer->file->filename }}"><i
                                                    ...
                                                    @if ($transfer->status)
                                                        <div class="form-group">
                                                            ...
                                                            @else
                                                            <label class="control-label col-sm-3" for="status">Moyen de paiement</label>
                                                            @endif
                                                            <div class="col-sm-9">
                                                                ...
                                                                @else
                                                                    <select class="form-control select2" name="status"
                                                                        ...
                                                                        @if ($transfer->status == 'Success')
                                                                            ...
                                                                            @if (!empty($transfer->bank))
                                                                                <option value="Success"
                                                                                    {{ $transfer->status == 'Success' ? 'selected' : '' }}>
                                                                                    Success</option>
                                                                                <option value="Pending"
                                                                                    {{ $transfer->status == 'Pending' ? 'selected' : '' }}>
                                                                                    Pending</option>
                                                                                <option value="Blocked"
                                                                                    {{ $transfer->status == 'Blocked' ? 'selected' : '' }}>
                                                                                    Cancel</option>
                                                                            @else
                                                                                <option value="Success"
                                                                                    {{ $transfer->status == 'Success' ? 'selected' : '' }}>
                                                                                ...
                                                                                <option value="Pending"
                                                                                    ...
                                                                                    Pending</option>
                                                                                <option value="Refund"
                                                                                    {{ $transfer->status == 'Refund' ? 'selected' : '' }}>
                                                                                    Refund</option>
                                                                                <option value="Blocked"
                                                                                    {{ $transfer->status == 'Blocked' ? 'selected' : '' }}>
                                                                                    Cancel</option>
                                                                        ...
                                                                        @else
                                                                            <option value="Success" >Orange Money</option>
                                                                            <option value="Success" >MTN Mobile Money</option>
                                                                           <!-- <option value="Success"
                                                                                {{ $transfer->status == 'Success' ? 'selected' : '' }}>
                                                                                Success</option>
                                                                            <option value="Pending"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2"><a id="cancel_anchor"
                                                                ...
                                                                href="{{ url(\Config::get('adminPrefix') . '/transfers') }}">Cancel</a>
                                                        </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <button type="submit" class="btn btn-theme pull-right"
                                                                    ...
                                                                    <i class="fa fa-spinner fa-spin"
                                                                        ...
                                                                        id="transfers_edit_text">Valider</span>
                                                                </button>
                                                            </div>
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    @if ($transfer->amount)
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p class="form-control-static">
                                                                    {{ moneyFormat($transfer->currency->symbol, formatNumber($transfer->amount)) }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="form-group total-deposit-feesTotal-space">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <p class="form-control-static">
                                                                {{ moneyFormat($transfer->currency->symbol, formatNumber($transfer->fee)) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if (isset($total))
                                                        <div class="form-group total-deposit-space">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <p class="form-control-static">
                                                                    {{ moneyFormat($transfer->currency->symbol, formatNumber($total)) }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    @endif
