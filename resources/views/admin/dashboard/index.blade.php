...
<section class="content">
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="small-box bg-yellow">
				...
				<a href="{{url(\Config::get('adminPrefix').'/users')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
	...
	<!--	<div class="col-md-3">
			...
			<div class="small-box bg-red">
				...
				<a href="{{url(\Config::get('adminPrefix').'/merchants')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div> -->
		...
		<div class="col-md-3">
			...
			<div class="small-box bg-aqua">
				...
				<a href="{{url(\Config::get('adminPrefix').'/tickets/list')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
	...
	<!--	<div class="col-md-3">
			...
			<div class="small-box bg-green">
				...
				<a href="{{url(\Config::get('adminPrefix').'/disputes')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div> -->
				...
				<div class="box box-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tr class="text-left">
							<td style="width: 35%;"><a href='{{  url(\Config::get('adminPrefix')."/tickets/reply/$item->id") }}'>{{$item->subject}}</a></td>
							<td style="width: 20%;"><a href='{{  url(\Config::get('adminPrefix')."/users/edit/$item->user_id") }}'>{{$item->first_name.' '.$item->last_name}}</a></td>
				...
				<div class="box box-body">
					...
					<div class="table-responsive">
						<table class="table table-bordered">
							...
							<tr class="text-left">
								<td style="width: 40%;"><a href='{{  url(\Config::get('adminPrefix')."/dispute/discussion/$item->id") }}'>{{$item->title}}</a></td>
								<td style="width: 30%;"><a href='{{  url(\Config::get('adminPrefix')."/users/edit/$item->claimant_id") }}'>{{$item->first_name.' '.$item->last_name}}</a></td>
