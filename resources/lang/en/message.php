...
return [
    ...
    'dashboard'            => [
        ...
        'left-table'    => [
            ...
            'withdrawal'       => [
                'withdrawan-with'   => 'Withdrawal With',
                'withdrawan-amount' => 'Withdrawal Amount',
            ],
        ...
        'payout'        => [
            'menu'           => [
                // 'list' => 'List',
                'payouts'        => 'Withdrawals',
                'payout-setting' => 'Withdrawal Setting',
                'new-payout'     => 'New Withdrawal',
            ],
            'list'           => [
                'method'      => 'Method',
            ...
            'payout-setting' => [
                ...
                'payout-type' => 'Withdrawal Type',
                'account'     => 'Account',
                'action'      => 'Action',
                'modal'       => [
                    'title'                    => 'Add Withdrawal Setting',
                    'payout-type'              => 'Withdrawal Type',
                    'email'                    => 'Email',
            ...
            'new-payout'     => [
                ...
                'withdraw-via'   => 'You are about to withdraw money via',
                //new
                'success'        => 'Success',
                'payout-success' => 'Withdrawal Completed Successfully',
                'payout-again'   => 'Withdraw Again',
            ],
        ],
        'confirmation'  => [
            'details' => 'Details',
            ...
            'fee'     => 'Fee',
            'total'   => 'Total',
            'mtRecu'   => 'Equivalent receipt amount',
            'taux'   => 'Daily exchange rate',
        ],
        'transaction'   => [
